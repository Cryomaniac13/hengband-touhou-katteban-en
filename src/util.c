...
menu_naiyou menu_info[10][10] =
{
	...
	{
		{"Cast spells (m)", 'm', TRUE},
		{"Read description (b/P)", 'b', TRUE},
		{"Learn spells (G)", 'G', TRUE},
		{"Class abilities (J/S)", 'J', TRUE},
		{"Innate abilities (U/O)", 'U', TRUE},
		{"", 0, FALSE},
		{"", 0, FALSE},
		{"", 0, FALSE},
		{"", 0, FALSE},
...
special_menu_naiyou special_menu_info[] =
{
	...
	{"MindCraft/Special", 0, 0, MENU_CLASS, CLASS_SUMIREKO},
