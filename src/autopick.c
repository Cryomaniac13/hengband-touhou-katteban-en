...
static char KEY_SOUVENIR[] = "souvenir";
static char KEY_RIBBON[] = "ribbon";
static char KEY_ALCOHOL[] = "alcohol";
...
static char KEY_MATERIALS[] = "materials";
...
static char KEY_SWEETS[] = "sweets";
static char KEY_SOFTDRINKS[] = "soft drinks";
static char KEY_ITEMCARDS[] = "cards"; //「アイテムカード」にすると上の「アイテム」の処理が先に行われてうまく動かなかった
