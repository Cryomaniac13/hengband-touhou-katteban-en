...
"You are a resident of Heaven. Though you spend your days dancing and singing, your fighting abilities are far beyond ordinary humans. You excel at hermit arts, but are completely inept at youkai arts. Since you've lived for a long time, your gain experience slowly. Just like hermits, you also will be targeted by assassins from Hell. Celestials receive no damage from holy attacks, but there are attacks that can severely damage them.",

"You are a fairy. Fairies are embodiments of nature appearing everywhere in Gensoukyou. They love pranks, but are very inept at combat. They hardly have physical or intellectual skills to speak of. On top of that, since they have no idea how to train themselves, they gain experience a bit slowly. At least they excel at hiding. Completing the adventure certainly would be no small feat.",
...
"You are a magician. In this context, 'magician' isn't a class - magicians are people who have learned how to sustain themselves with their own mana. Many of them were humans at first, but there are also born magicians. You're weak physically but excel at magic. Your spirit grows stronger as you level up, giving you resistance to confusion and sustaining your intellegence. You also can drain mana from living beings by touching them. Being sustained by your own mana, you require no food at all.",

"You are a crow tengu. Tengu are a major force on Youkai Mountain, crow tengu are the news reporters. You boast extreme speed, are comparatively smart and are good at youkai art and hermit arts of nature. You have a special camera that can erase enemy danmaku attacks and bolt spells. Tengu have to wear a 'tokin' on their head.",
...
"You are a youkai fox in human form. Unlike most other youkai, you are comparatively weak but fairly intelligent, making you inclined towards using magic. In particular, you excel at transformation arts. Regardless of your class, you have ability to deceive your enemies, and will obtain telepathic powers as you level up. Your keen beast sense gives you high survivability. On higher experience levels, you might obtain some degree of divinity, getting rid of your weakness to holy attacks. It's a powerful race that takes a fairly long time to level up.",
...
"You are a merfolk, with upper body of human and lower body of a giant fish. Your tail prevents you from wearing boots, and you move slightly slower on land if you're not levitating. However, being in water makes you very fast, and that huge tail lets you deal strong blows in close combat. You're not that bad at magic either, and are inclined towards using youkai arts.",

"You are a hobgoblin. They are pitiful youkai that were invited to Gensoukyou as stand-ins for the zashiki-warashi (who are said to bring good fortune to households), but were chased out of Human Village due to their grotesque appearance. Since their body build is similar to that of an infant, they're not good at fighting, but are unexpectedly good at other skills and gain levels quickly. They become resistant to poison and paralysis as they level up.",

"You are a nyuudou. They are youkai with good physical build, but they also can grow bigger or smaller, appear or vanish. Their ambiguous substance gives them high physical defense, and they gain resistance to paralysis, shards and sound on higher levels. They make better warriors than mages, though they are proficient at youkai arts of transformation.",
...
"You are a stone statue animated by magic. You have high strength and constitution, but you move slowly. You almost lack intelligence, making using magic extremely difficult. Your stone body gives you many resistances, but disenchantment attacks will severely hurt you. You feed on rocks and minerals, and eating rare minerals can heal you and give you benefical effects. On higher levels you will be able to eat dungeon walls.",

"You are an inchling. You aren't even as tall as the average human's knee height, and your physical abilities are lowest out of all races, even lower than those of fairies and ghosts. Since you are so small, you cannot equip heavy items. However, your stealth and evasion abilities are unparalleled, and since even walking down a road is an ordeal for you, you gain levels quicker than anyone. You also are good at searching and using magic devices.",

"You are a corpse animated by magic from the mainland. You body is rigid, limiting your movement, but you can become more flexible with training. Your strength and constituion are high and your resist various attacks like poison, nether or darkness, but are extremely weak to holy attacks.",
...
"You are a noble Lunarian who has descended to the earth due to some circumstances. Having lived for an extremely long time in the Lunar Capital made you far more wise than the humans on earth. You abhor smell of death and the breath of life, as it is 'impurity' to you. Because of that, you're not good at magic classified as 'youkai arts', and are horrible at life and nature magic. You are completely immune to holy attacks, but various impure forces deal significant damage to you. You excel in many skills, but don't like combat too much.",

"You were reborn as a ninja by being possessed by Heiean period Ninja Soul.",
...
"You were a kobito as tall as human's knee, but Miracle Mallet made you human-sized.",
...
"You are proficient at handling weapons and can pave your way by brute force. You're not just good at hacking and slashing, but have skill in using projectile weapons as well. You're rarely outmatched in one-on-one combat, but are very bad at everything else. In order to survive in the dungeon past midgame, you have to do something about your underwhelming magic device skill and stealth.",

"To you, knowledge is power. In order to unlock mysteries of magic, you perform daily research and practice. Early on you will struggle due to your lack of physical abilities, but later on you will be able to fight in a variety of powerful ways. You are clever and good at searching and using magic devices. As you gain experience, you will be able to drain mana from magic devices. You can study 2 realms of magic out of all twelve. Depending on the kind of first realm picked, you will be known as an 'Arcanist', 'Michinoshi' or 'Sorceror'. You can change your second realm at any time, but spell difficulty will significantly increase if it isn't the same kind as your first realm.",

"You serve gods through ceremonies and prayers. Divine aid lets you study 2 realms of hermit arts. Your faith gives you excellent protection against magic, and you will gain resistance to fear as you level up. Your daily training has given you some skill in martial arts, but you're not a master of them. Wield non-blessed weapons (other than blunt weapons) will displease your deity, hindering your spellcasting. You gain experience levels slowly, but you can obtain experience by offering items to your deity. You also might serve an evil god or a curse god; in this case, you learn sorcery arts instead of hermit arts and receive penalties if you wield a blessed weapon.",

"You are a so-called treasure hunter looking for treasures in ruins and monster lairs. You excel in various skills like stealth, unlocking, disarming and throwing, and have useful abilities suited for exploration. Since running into monsters and ruin guardians is an occupational hazard, you have some skill in combat, but you're not as good as a pure warrior. You can study one realm of magic, but you will learn spells slowly and won't be able to use particularly strong magic. You are proficient with short blades and will gain extra attacks when wielding them. Aside from short blades, you're good with crossbows, but are bad at handling heavy weapons.",
...
"You are a noble warrior fighting to protect your sanctuary. You are good at melee and are particularly skilled with swords and spears. You can't use magic, but you have some abilities to protect yourself from enemies. Wielding a blessed weapon increases your attack power, wielding a cursed one significantly reduces it. You're also good at riding, but are very bad at handling chaotically aligned beasts. You will gain resistance to fear and holy attacks as you level up.",

"Your mission is to acquire a deep knowledge of various things and pass it on to the younger generation. This is a versatile class capable of studying 2 realms of magic as well as using wide range of weapons and combat techniques. However, you're a master of none of those abilities, and there's little room for skill growth. In order to survive past midgame you have to use everything you can get.",

"You are a dependable servant to your master; you do daily chores, intercept any intruders, and assault enemy territory with little regard for your life. You are decent at handling various weapons and searching, and you will learn some useful abilities. You also can study one realm of magic (though not as well as more magically inclined classes); this is a versatile class. However, as a maid (butler), you must always wear maid clother (suit). Obtaining good armor is going to be tough. As you level up, your master will give you rewards. However, if your master is in a bad mood, you might receive unreasonable punishment instead.",

"You prefer to fight without using a weapon, and work hard every day to train your body and skills. As a result of this training, your bare hands are comparable in power to that of a heavily equipped warrior. Through rigorous training you've learned to use 'Ki', giving you abilities far beyond ordinary people. However, equipping shields or heavy armor will interfere with your martial arts, so choosing your equipment is going to be difficult. You're not good at disarming traps or using magic devices.",

"You are a so-called psychic, capable of performing wondrous feats through the power of your mind. It has a wide range of abilities, being particularly good at defense and detection. Learning mindcraft abilities doesn't require intelligence, it depends only on wisdom and character level (mindcraft abilities are used through the same command as magic). You are somewhat frail but still have some combat skill; it's a versatile class that's easy to play. You will gain resistance to confusion and telepathy as you level up. You gain levels quickly but your score is lowered.",

"To you, knowledge is power, and you have decided to focus on a single realm of magic. While you can study only one realm, you are far better at it compared to other classes. You have far more MP than other magical classes, and will gain special abilities according to your realm at certain level. Your class name will change according to the realm you picked.",

"You are an ordinary resident of Gensoukyou. You might be a tofu merchant in the Human Village or a fairy playing in a flower garden. For some reason you've decided to explore dungeons, but you have almost no combat skills. You can study one realm of magic, but the stronger spells are out of your reach. Your adventure is going to be tough. Also, you can change your class name at the start of game.",

"You are a mountain hermit devoted to training your body and soul. You are good at fighting with katanas and staves, and are proficient at martial arts as well. Wielding a staff makes it easier to get more attacks. You can study one realm of magic belonging to hermit arts, or you might study the heretical magic of transformation or necromancy. As you level up, you will gain resistance to fear and confusion, and will gain the ability to quickly recover MP by focusing your mind.",

"You are a warrior who has mastered both swordsmanship and magic. Your combat skills are far from a pure warrior's, and you're not as good at studying magic as magical classes, but you can perform special attacks by casting magic on your sword. You can learn a single realm of either any of arcane arts or darkness/chaos of sorcery arts; the effect of your magic sword will change according to chosen realm. You are very good with swords, but aren't skilled with other weapons. As you level up, you will be able to see invisible things and regenerate quickly. You gaing levels a bit slowly.",

"You are a strange mage fascinated with Gensoukyou's danmaku duels; you study day and night so you can reproduce the danmaku by yourself. You learn by observing monster spells and will be able to use them once you've studied enough. Ease of learning depends on the level and difficulty of the spell, your level and intelligence, and how far away you are from the monster. Keep in mind 'observing a spell' usually means getting hit by it. In the end you might obtain tremendous power, but the road to that can be a series of hardships and dangers.",

"You are a warrior who specializes in using bows and crossbows. You are tremendously skilled, being able to shoot with precision and speed several times greater than that of a normal person. However, you are far less skilled in close combat in comparison to other combat oriented classes. You can make arrows from trees, and you can make even stronger ammo at Archers Guild if you bring them arrows and materials. You are average at other skills like stealth or searching. As you level up, you will be able to see invisible and gain resistance to blindness.",
...
"You are a mechanical engineer, manipulating complex and bizarre machines to use on the battlefield. You can build machines and obtain ammunition at the Engineer Guild. You have a levitating backpack to store your machines. Since there are many types of machines, you have to carefully pick the ones you want. Machines are extremely powerful, but they have the drawback of requiring a significant amount of money. Building machines requires intelligence and dexterity, but high charisma might be required as well to sell loot at high price. Water and electricity are the bane of many machines; they might get temporarily disabled if you get hit by those attacks. Your own combat abilities are average. You are good at using crossbows and disarming traps, but aren't skilled at using magic devices.",

"You work in a library; you serve the owner, do chores and deal with thieves. You have a wide knowledge of magic books, and surprisingly, can recall magic from all realms up to their second books. You can cast spells if your level is high enough and you carry the proper book. However, you're far less skilled than a full-fledged mage, and any powerful spells starting from third books are off limits to you. You have some proficiency with weapons, but again, you're hardly a master, and can't wield heavy weapons very well. You won't have much trouble early on, but fighting strong enemies in late game might be tough. As you gain levels, you will learn how to cast spells quickly at the cost of consuming more MP.",

"You are honing your skills every day to master the path of the sword. You're unmatched when it comes to fighting with a katana. You can't use magic, but you can learn 'sword techniques' by reading books written by your ancestors. You also fight in a special way by taking a certain 'stance'. You're skilled at dual wielding, but aren't good at searching or using magic devices.",

"You're a warrior who uses firearms. You're good at handling guns and knives, and have some skill in martial arts, unlocking and stealth. However, you're bad at using magic devices, and your saving throw is low. You can get skill points by leveling up and spend them to learn skills from several categories. The way you spend your points is going to affect how you're going to clear the dungeons. Since you're clearly dressed unlike other Gensoukyou residents, you exercise caution while walking around.",

"You make a living by making and selling medicine. You obtain materials and recipes in dungeons, and create potions in pharmacy rooms in towns. You're not particularly good at fighting, so you'll have to prepare explosive or strengthening potions before facing strong enemies. You always carry a medicine box to store materials and potions apart of your main inventory. Items stored there are protected and cannot be damaged by attacks, but you cannot use them before taking them out. As you gain experience, potions in your inventory will be less likely to get destroyed by cold attacks. Making potions requires intelligence, and obtaining materials requires stealth, searching and some combat preparation.",
...
"You are a business savvy merchant or speculator, planning to make a profit on buying and reselling ability cards. However, other people have the same idea, and inflation is going to be inevitable. Anyway, hurry up and save money to buy cards from card stores around Moriya Shrine, gambling den in False Heaven Shelf or directly from the card holders. You have some proficiency in combat and magic. You carry a card case which can hold up to 8 different types of cards. You need magic device use skill to activate the cards and charisma to raise their power and get more money.",

"You found yourself standing in an unknown meadow. For a short while, the untouched natural scenery makes this place completely incomprehensible to your common sense; there are monsters roaming around, and you know that you are totally helpless. You've had the fortune to arrive at a place where other humans live. You are not the first human to wander into this world, and kind people told you that you can go back to outside world if you visit the Hakurei Shrine - however, the road to the shrine is full of youkai. It looks like some incident has occured there; however, you have no idea what is an incident and what is everyday life in this place..."
#endif
};
...
"Muchkins are the beginner's training personality. All of your abilities are raised. It's easy to win with this personality, but it's not much to be proud of.",
...
static cptr seikaku_special_jouhou[MAX_SEIKAKU_SPECIAL] =
{
    ...
    "Even though you're an ice fairy, you somehow managed to get tanned. You're no longer vulnerable to fire, all of your stats are increased, your special abilities are more powerful; you're more powerful all around in general. However, your score will be halved. There's a mysterious door opened on your back, but you're not noticing that."),
	//パチュリー「書痴」
	_("あなたは手当たり次第の本を一心不乱に読み漁り、ついに魔術だけでなく仙術と妖術の魔法までも全て習得しました。しかし無理が祟ったあなたはいつにも増して健康を損ない、今の身体能力は雑魚妖精にすら劣ります。",
    "You keep collecting books of all kind, and now you're able to learn Hermit and Sorcery Arts, aside from Arcane Arts you already know. However, that has taken a toll on your health, and your physical stats are lacking in comparison to an average fairy."),
	//成美「理由なく好戦的な」
    ...
    "You were quietly living in the forest, but then you suddenly felt immense amount of magical power build in you, so you couldn't help but to test it out. Your close combat skills are now better, your maximum MP is increased, and you have more powerful combat special abilities, however your score is lowered. There's a mysterious girl waving bamboo grass dancing behind your back, but you're not noticing that."),
	//うどんげ「夢の世界の」
    ...
    "Lately, you've been suffering from nightmares. All of Gensoukyou residents, who supposedly should be somewhat friendly, are constantly attacking you. However, during one night, someone calling themselves the Ultimate Secret God has given you new power. Use your new abilities to defeat the unending nightmares. The abilities granted to you by the secret god are picked at random, and you can name them to your liking."),
	//針妙丸「意外に顔が広い」
...
static cptr realm_jouhou[TV_BOOK_END + 1] = {
...
#else
    "The realm of manipulating the elements making up all creation - earth, water, fire and air. It has most varied attacks and some defensive and auxiliary magic. You can deliver effective blows to enemies by using proper elements.",
    ...
    "The realm of smiting evil. Has attack spells effective against youkai, demons and undead, and has some support spells as well. Last spellbook has spells that let you take on divine aspects, but only one at a time.",
    "The realm of nature's power. Has variety of balanced spells, particularly good at defense and detection. However, attack spells are a bit weak.",
    "The realm of changing your body and surrounding terrain. Has varied powerful techniques, but racial aptitude significantly influences the spell difficulty level. Also, transformation magic can include risks like armor becoming ineffective or scrolls becoming unusable.",
    "The realm of manipulation evil forces. Has attack spells that use poison or darkness, extremely aggressive support spells, demon summoning and demon transformation. However, it's not good at defense or detection. Studying this realm makes you vulnerable to holy attacks.",
...
static unique_player_type unique_player_table[UNIQUE_PLAYER_NUM] =
{
	...
	"You are a magician by birth; you spent most of your life reading books. Currently you are living in the Great Library at Scarlet Devil Mansion and rarely go outside. You have an extremely extensive knowledge of magic, and are able to use all 4 realms of arcane arts. You can use any spell as long as your level is high enough and you are carrying the required spellbook. You also are capable of manipulating magic of the seven days of the week, making your MP recover extremely quickly. However, your physical stats are lacking, you have trouble carrying too much weight, and are inept at close combat. You also have asthma; if your condition worsens, your failure rate goes higher, and you might fail to read scrolls. You can improve your condition with potions of curing or potions of life."},
    ...
    "You are a youkai capable of manipulating cold. You hide away somewher while it's warm, and go outside when winter arrives. You're good at cold and sleep-inducing attacks; you might defeat enemies without letting them make a move if you use them properly. You're good at fighting living beings, but are pretty much powerless against enemies like undead or golems. You're resistant to cold, but fire hurts you greatly. You might not have much trouble early on, but you will struggle towards the end. You can't change weather conditions by yourself, but you're especially powerful in midst of a blizzard.")},
    ...
    "You are shikigami of the great youkai Yukari Yakumo's shikigami Ran Yakumo. You don't have a family name. You are good at moving without being noticed, and can perform abilities like moving next up to a distant enemy in an instant, attacking and then immediately escaping. However, if you get hit by water or enter water terrain without levitation, your shikigami powers will be cut off, weakening you. Without them, you're more or less an ordinary bakeneko. You can restore your lost powers by visiting your exploration base. You're not that good at handling weapons or magic devices.")},
    ...
    "You are a puppeteer. You keep doing daily research, aiming to create a doll that can perfectly move by itself. You have a unique combat style; instead of holding a weapon, you fight with armed dolls you manipulate with magic strings. Aside from manipulating dolls, you can study one realm of magic. Amount of dolls you use increases as you level up, and their attack power depends on your intelligence, dexterity, the kind of the doll and the weapon it's holding. Any special abilities of your dolls' weapons like resistances or stat increases do not affect you. While your dolls are powerful, you yourself are weak, so having good armor will be vital. However, you cannot equip gloves, since they prevent you from using dolls. Since you rely on precise magic, you're vulnerable to disenchantment attacks. You can't ride at all.")},
    ...
    "You are the youngest of the three poltergeist sisters. You are always bright and cheerful, to the point you sometimes have trouble clearly communicating. You have the power of lifting spirits of those who hear your performance. You three live at the Ruined Western Mansion, and you can switch with your other sisters there. All three of you share experience, stat values and possessions. As a ghost, you are capable of walking through dungeon walls. It's very useful for exploration, but your score is greatly lowered, and you're vulnerable to holy attacks. If you win without switching with your sisters even once, your score will be raised.")},
    ...
    "You are one of Gensoukyou's eldest great youkai, responsible for maintaining order in Gensoukyou. You are capable of manipulating 'barriers', which lets you use powerful and strange abilities. Your stat values are high as well, and your intelligence in particular is unrivaled. However, your score will be extremely lowered, and you gain levels very slowly.")},
    ...
    "You are a half-beast; you are a teacher at a temple school in Human Village and are trusted by humans. You are capable both at close combat and using magic. You are capable of eating history, which gives you ability to 'conceal' some events or beings. You are surprisingly intelligent for a were-beast, and you have a very hard head. You usually don't look beastly, but during full moon, your hakutaku half awakens, dramatically powering you up. You grow large horns in hakutaku form, so be mindful of your headgear.")},
    ...
    "You are a very old youkai rabbit; you lead rabbits at Eientei. You are very cunning and capable of fighting with traps and hit-and-run tactics. Also, you start the game with a large sum of money you've saved up. However, your stats and combat skills aren't high, so the end of your quest is going to be tough.")},
    ...
    "You are a youkai rabbit from the Moon. You have particularly remarkable combat sense among the usually laid-back moon rabbits. You have an extremely versatile ability of manipulating wavelengths, which lets you use abilities both for offense, defense, and detection. Living on Earth for so long has deprived you of holy energy resistance of the moon rabbits.")},
    ...
    "You are a human who has become immortal by drinking the Hourai Elixir over thousand years ago. You have the rule-breaking ability to revive on the spot once you lose all of your HP. You spend MP upon resurrection, and if you run out of both, it's game over. You can afford to be more reckless than usual in combat, but you have to watch your remaining MP. You might be immortal, but your physical abilities aren't that high, but you've gained plenty of skills having fought for hundreds of years. You can study one realm of magic, but you cannot use transformation spells as your body can't change at all. You've grown weary of life after over thousand years, and you need a lot of experience to level up. Also, your score is greatly reduced upon resurrection.")},
    ...
    "You are a doll discarded at the Nameless Hill. It hasn't been long since you gained sentience, and you explore various places to widen your knowledge. You have the ability to manipulate poisons, and all of your martial art attacks can poison. Your body is filled with valley lily poison;  you gain satiation by absorbing poison, but unlike normal youkai dolls, you cannot consume magic devices. Your stats are on average level. You're good at fighting living beings, but dealing with enemies unaffected by poison will be hard. Instead of gaining experience normally, you level up by equpping powerful items.")},
    ...
    "You are a shinigami acting as the boatman of Sanzu river. You frequently leave your work behind and get involved in something else. You have a useful ability of manipulating distance, with plenty of teleport-related abilities. You also have shinigami-like abilities like calling ghosts or striking down living beings in a single strike. You can't bring yourself to strike your boss, Eiki Shiki.")},
    ...
    "You are the Yama appointed for Gensoukyou. You were a jizo before you became Yama. You have the ability to clearly establish things as good or evil; in game terms, this means there will be no randomness in movement order for you and other beings. You also have a solitary and extraordinary mind specialised in judging people, so you're not affected by any mental attacks. Your weapon is a board called 'Rod of Remorse'. It gets more powerful depending on enemy level, and never misses. You have other various and powerful abilities, but you gain levels slowly and your score is greatly lowered.")},
    ...
    "You are a misfortune god. While you're called a god, in reality you're closer to a youkai, and are vulnerable to holy attacks. You can absorb misfortune and store it in your body. You accumulate misfortune by draining it from cursed items and receiving 'evil' attacks from enemies, and you can reduce it by spending it with your abilities to attack enemies. You become stronger as you accumulate misfortune, but accumulating too much will be extremely dangerous, so keep that in mind. People avoid you, and buying/selling items will be tough, but you can get some money from your hina doll sales office in Human Village. Also, if you keep fighting while having items with minus effects equipped, you might inverse those minus effects. However, this is extremely rare.")},
    ...
    "You are a kappa engineer. Like a normal engineer, you can develop machines by using a lot of money. You don't have much room on your rucksack to attach machines, but you also can use special abilities and your own machinery. You can use your machines as soon as you reach high enough level, and you can recharge their energy on water terrain. They're lacking in power compared to normal engineer machines, but they're more cost efficient. You also have several close combat gimmicks installed on your rucksack, so you're better at martial art combat. You have the ability to manipulate water, which lets you use some water attacks.")},
    ...
    "You are a patrol tengu at the Youkai Mountain. You have the ability to see a thousand ri ahead, making you excellent at detection and searching. You can see in darkness without a light source, and you gain resistance to blindness as you level up, along with being able to detect nearby enemies. However, your combat abilities are average. Also, you cannot wear anything on your head aside from a tokin.")},
    ...
    "You are fiercely enthusiastic crow tengu writing a newspaper about the girls of Gensoukyou. Despite your appearance, you're very old even for a crow tengu. You're unmatched in terms of speed and agility, and are even faster on world map and can't get ambushed. You're good at close combat, can study either Mysticism or Nature realm, and also have several useful special abilities, making you an excellent all-around character. However, you gain experience levels very slowly, and your score is greatly lowered.")},
    ...
    "You are a wind celebrant, a shrine maiden serving a god of wind. You've been losing faith in the Outside World, so you've moved to Gensoukyou along with your gods. You have some divine blood in you as well, and are capable of causing powerful miracles. However, in order to do that, you have to keep chanting for several turns - possibly as long as tens of turns. You'll have to read enemy movements ahead and wait as you keep chanting. Your physical stats aren't too different from those of ordinary humans, so you're not good at physical combat.")},
    ...
    "You once were the strongest of the native gods, but now you leave shrine management to Kanako and live a pleasant life as a god. You can manipulate earth by borrowing the powers of scourge gods, you can study all realms in Sorcery Arts, and you're fairly decent in close combat as well. You've lost most of your power, so your MP is low, making using spells/special abilities difficult; however, if you keep defeating human enemies, you'll become feared once more, raising your maximum MP. All in all, you're extremely powerful, but you gain experience levels very slowly and your score is greatly lowered.")},
    ...
    "You are a tsurube-otoshi youkai who likes dropping down on the heads of other people. You're always sitting in a bucket, so you can't wear anything other than a bucket as body armor, and you can't use footwear as well. Your combat arts involve dropping down on your enemies from above. You're usually limited to one melee attack per round, but it's a powerful one, and gets even more powerful if you're wearing a high quality bucket. You also have the ability to rise up in the air, greatly increasing the power of your dropping down attacks.")},
    ...
    "You are a deeply jealous bridge princess, capable of either tapping into your own jealousy or inducing jealousy in others. Your attack power increases against enemies that are more high level than you, especially if they're female. Also, your power and speed increases the lower you are on health. You have other special abilities, but they're mainly high-risk, relying either on you being low on health or going against powerful enemies. Since your stats and combat abilities aren't high, you have to exercise caution when facing strong enemies.")},
    ...
    "You are a powerful oni, one of the Big Four. Your unrivaled strength is absolutely devastating. While you are extremely strong, you're not interested in training your weapon or martial art skills, prefering to simply crush enemies with brute force. You're always holding a sake cup in your off-hand; its mysterious power makes any sake you drink from it delicious.")},
    ...
    "You used to be an average hell raven living as a pet in Palace of Earth Spirit, but after consuming a Yatagarasu, you drastically powered up, becoming capable of manipulating nuclear fusion. Right now, your body is an inexhaustable source of energy. You have powerful ranged attacks, but most of them are either fire or light element, so you might have trouble against enemies resisting those. You're unskilled in skills like magic device use and trap disarming, since you're not good at anything other than scorching and blowing stuff up. Also, two of your limbs are outfitted with devices to control nuclear fusion, so you can wear only one glove or footwear, lowering their effectiveness.")},
    ...
    "You are a satori youkai who has sealed her heart and third eye. You don't have a clear consciousness and just randomly wander around Gensoukyou. Having sealed your mind-reading eye, you instead obtained the power of manipulating unconsciousness, and enemies might be unable to perceive you even if you're in front of them, making it easy to deliver a devastating sneak attack. However, this is less effective against enemies with unusual mind. You're not affected by mental attacks of any kind.")},
    ...
    "You're a youkai rat dispatched by Bishamonten; right now, you're cooperating with Myouren Temple and live near Muenzuka. You're a master at dowsing and tresure hunting. You also have some minor abilities like summoning rats or hit-and-away combat, and are good at stelath and magic device use. As a servant of Bishamonten, you're not weak to holy attacks despite being a youkai. However, you're very frail, and your combat abilities aren't that high either. You have to be very careful, and even then, your quest is going to be a dangerous one.")},
    ...
    "You're an umbrella tsukumogami called a 'karakasa-obake'. The umbrella you're holding is your actual body, and you can't let go of it. You fight by swinging this umbrella around. As an umbrella, you're resistant to water, but acid and fire will hurt you. Combined with racial abilities of a tsukumogami, you start vulnerable to acid, fire, holy attacks and disenchantment. Your umbrella powers up as you gain levels. Unlike normal tsukumogami, you can't gain sustenance by draining magic devices, instead gaining it by surprising someone. You're a skilled blacksmith; you can appraise weapons/armor and improve metallic weapons/armor.")},
    ...
    "You are a rare youkai, a nyuudou-user; you're always seen together with a cloud-like nyuudou called Unzan. In martial art combat, Unzan attacks instead of you. Unzan's huge fist are very powerful, though their attack power won't rely on your strength. Wearing heavy equipment still will interfere with your martial art combat. Unzan also has several useful abilities like attacking distant enemies or firing lasers, and he can protect you if you're in danger. However, you need your both hands free to cooperate with Unzan, and your attack power drops greatly if you're holding something.")},
    ...
    "You were a youkai beast born from human imagination, and right now you're working at Myouren temple as a servant of Bishamonten. As a semi-divine being, you have resistance to holy attacks despite being a youkai. You physical stats are high, you have keen beastly sense, and you're pretty good at skills like magic device use. You have the ability to gather treasure, so money isn't going to be a problem. You start out with Jeweled Pagoda of Bishamonten, which lets you use powerful ranged attacks. Though you're strong all around without any notable weak points, you're unskilled at weapon use despite your valiant appearance. If you lose your pagoda, you won't be able to use many of your abilites, so keep that in mind.")},
    ...
    "You are a great youkai once greatly feared in Heiankyou. You have the ability to make alter perception of things, making you good at hitting enemies with mental attacks. You can freely explore without having a light source, and enemies are less likely to notice you in the dark. You also can hide your true identity, taking the form of a monstrosity. While transformed, you're powered up, but once an enemy sees through your transformation, you won't be able to transform until that enemy leaves the dungeon level. Standing in illuminated areas, being noticed by smart enemies or getting hit by your vulnerabilities is likely to reveal your true form. You're generally very strong, but you gain experience levels slowly and your score is very low.")},
    ...
    "You're a yamabiko youkai with dog-like ears and tail. You earnestly practice at Myouren Temple in morning, but surprisingly, you're also a punk rocker at night. You have special abilities like shouting out loud or causing echoes, you can stun enemies with sound attacks or echo spells they cast. As you level up, you become completely immune to sound attacks, and will be able reflect enemy bolt spells. However, your physical stats aren't that high, and you're not good at combat. Since you fight by shouting, your stealth is horrible as well.")},
    ...
    "You are the boss of the bake-danuki; while you're a youkai, you've been living in the Outside World until recent times, and you've already assimilated into the society of Gensoukyou. Your powers include abilities to transform either yourself or the enemies. Also, you can call your tanuki subordinates to attack your enemies. Transformation skills require intelligence and wisdom, using your followers requires charisma.")},
    ...
    "You are a mermaid living at Misty Lake, singing song and collecting stones. You're normally fairly quiet and your combat abilities are very low, but you grow more powerful while in water. You have several water-related abilities, but you can't use magic. As you level up, you will become even more powerful while in water, and also you will be immune to water attacks. Also, as a mermaid, you can't wear boots.")},
    ...
    "You are a rokurokubi youkai, you live in Human Village while hiding your true form. You're not only able to extend your neck, but you also can send your head flying, create clones of your head or fire lasers from your eyes. Amount of your head clones and their power increases as you level up, and you share their line of sight. Your combat abilities aren't low, but they're not particularly notable for a youkai. You're good at close combat in open areas with support of your head clones. You're good at riding, but your other skills aren't great. You can't wear amulets.")},
    ...
    "You are a rare Japanese wolf-woman, you normally live in Bamboo Forest of the Lost. You have comparatively high physical stats, but you're not good at handling weapon, preferring to fight with martial arts. Also, while you're agile, you're not that manually dextrous. You can study either Transformation or Darkness realm; you can't use more complex spells, but you excel at some of transformation spells. You're proud of your long, glossy hair and hate fire/electric attacks that mess it up. You grow even more powerful under full moon, and can transform into a mighty wolf. Some of your equipment is disabled during transformation, so keep your resistances in check.")},
    ...
    "You are powerful, wise and brave tsukumogami. You can draw out the power of your equipped weapons, making them stronger, and also you will be able to use spells or breath attacks depending on your weapon abilities. However, fixed artifacts have a strong sense of identity and can't be affected by this power. Also, as a musical instrument tsukumogami, you can play music with various effects. You performs using both your hands and legs, so your performance won't be interrupted by melee attacks or using items. You're generally very strong and gain experience levels comparatively quickly, but your score is greatly lowered.")},
	...
	{TRUE,_("鈴瑚", "Ringo"),CLASS_RINGO,RACE_GYOKUTO,ENTRY_KANZYU,SEX_FEMALE,
        ...
        "You are one of the Eagle Ravi group dispatched from the Moon to conduct recon on Earth. You're responsible for information management, and are proficient at searching and surveillance. Your combat abilities are average, but you have a mysterious ability to power up by eating dango. When going gets rough, eat some dango and push through. You won't slow down even if you eat too much dango. Also, occasionaly your allies will leave you dango relief supplies during your dungeon exploration.")},
    ...
    "You are a major figure in Lunar Capital, and you also are responsible for manifesting occult in Gensoukyou. Whenever you talk about something, that situation will get reversed regardless of your intentions. Be careful - reading scrolls will have completely different effects. As a lunarian rejecting any impurity, you are greatly vulnerable to impure attacks.")},
    ...
    "You are an old and powerful divine spirit. At the core of your being, there is strong and insatiatiable hatred and thirst for vengeance. The grudge you're holding is with Lunarians; just seeing them fills you with desire to crush them. You have the ability to 'purify' things, bringing forth the very essence of their being, letting you perform extraordinary feats.")},
	...
	{TRUE,_("爾子田 里乃", "Satono Nishida"),CLASS_SATONO,RACE_DEMIGOD,ENTRY_TENKUU,SEX_FEMALE,
        ...
        "You are a subordinate of the secret god Okina Matar; your main job is to dance wildly behind someone. You can recruit monsters and empower their mental power by dancing behind their back. Dancing behind someone's back is treated as riding, except you can dance behind monsters you can't normally ride as well. Your combat power with greatly increase if you manage to recruit a powerful monster. However, your own combat abilities aren't that high.")},
	{TRUE,_("丁礼田 舞", "Mai Teireida"),CLASS_MAI,RACE_DEMIGOD,ENTRY_TENKUU,SEX_FEMALE,
        ...
        "You are a subordinate of the secret god Okina Matar; your main job is to dance wildly behind someone. You can recruit monsters and empower their physical power by dancing behind their back. Dancing behind someone's back is treated as riding, except you can dance behind monsters you can't normally ride as well. Your combat power with greatly increase if you manage to recruit a powerful monster. However, your own combat abilities aren't that high.")},
	{TRUE,_("摩多羅 隠岐奈", "Okina Matara"),CLASS_OKINA,RACE_DEITY,ENTRY_TENKUU,SEX_FEMALE,
        ...
        "You are a mysterious god who has been hiding behind the scenes for a long time. You have been controlling Gensoukyou through the mysterious powers of Back Door. You can open doors on monsters' back, tapping into their powers for your own use, and you will be able to use more of their special abilities as you level up. As you have many other names aside from 'God of Back Door', you also learn many various and powerful special abilities. You can see in darkness as in plain daylight, and you can walk through closed doors as if there isn't anything there.")},
	...
	{ TRUE,_("杖刀偶 磨弓", "Mayumi Joutougu"),CLASS_MAYUMI,RACE_HANIWA,ENTRY_KIKEI,SEX_FEMALE,
        ...
        "You are the captain of Haniwa Corps created by the sculptor god Keiki Haniyasushin. You learn abilities summoning haniwa warriors, and you can maintain plenty of haniwa followers with low MP cost. Your own combat abilities are very high, and you are particularly skilled in handling swords/bows and riding. You also can turn your loyalty into strength, making your strength and constitution at least as high as your wisdom. While you look just like a human, you are actually a hollow haniwa. This makes you unusually resistant to some attacks, but you are vulnerable to sound and shards.")},
    ...
    "You are a former human who has became a celestial along with your noble family, but you're being called a 'delinquent' due to your bad behaviour. However, you are powerful, having several strong abilities involving manipulating the earth. Your favourite weapon is the treasured sword of Heaven, 'Sword of Hisou'. Some of your abilities require you to wield it.")},
    ...
    "You're a group of three fairies called 'Three Fairies of Light'. Sunnymilk manipulates refraction of light, Lunachild erases sounds, Star Sapphire detects nearby living beings. The three of you explore the dungeon together; you can equip up to 2 weapons, 1 shield, 1 light source, and up to 8 armor pieces/accessories. However, you can only equip up to 3 items of the same kind. You don't take penalties for dual wielding or combining close combat and ranged weapons.")},
	{TRUE,_("サニーミルク", "Sunnymilk"),CLASS_SUNNY,RACE_FAIRY,ENTRY_OTHER,SEX_FEMALE,
	...
	{TRUE,_("ルナチャイルド", "Lunachild"),CLASS_LUNAR,RACE_FAIRY,ENTRY_OTHER,SEX_FEMALE,
    ...
    "You are a moon rabbit. You escaped to Earth because you grew to dislike living making mochi day after day, but after certain events, you became a member of Lunarian Defense Corpse. You're not that good at combat, but sometimes you can move at surprising speed.")},
