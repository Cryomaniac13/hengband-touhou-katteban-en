  ...
  {
    {
      ...
      { 25, 30,  70, "Wave-Motion"},
      { 28, 26,  50, "Summon Ghost"},
      { 32, 35,  65, "Purgatory Flame"},
...
msg_print("その方向にはモンスターはいません。");
	...
	case 10:
		...
		/*:::八方手裏剣*/
	case 11:
	msg_print(_("くさびがなくなった。（この世界から）", "You have no more Iron Spikes. (Nobody does)"));
	break;
#if 0
	{
		int i;
